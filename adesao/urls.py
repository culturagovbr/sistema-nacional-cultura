...
urlpatterns = [
    ...
    path('sistema/troca-cadastrador/', login_required(views.TrocarCadastradorView.as_view()), name='troca_cadastrador'),
    ...
    path('sucesso-solicitar-adesao/', views.sucesso_solicitar_adesao, name='sucesso_solicitar_adesao'),
